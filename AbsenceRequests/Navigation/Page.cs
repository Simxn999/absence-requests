...
namespace AbsenceRequests.Navigation;
...
public class Page
{
    ...
    public static void PrintEmployee(Employee employee)
    {
        ...
        WriteLine(employee.Name.Trim().Any() ? employee.Name : "[UNDEFINED]");

        CursorLeft = Indent;
        Write("Surname:");
        CursorLeft = Indent + 18;
        Positions.Add("Surname", (CursorLeft, CursorTop));
        WriteLine(employee.Surname.Trim().Any() ? employee.Surname : "[UNDEFINED]");

        CursorLeft = Indent;
        Write("Email:");
        CursorLeft = Indent + 18;
        Positions.Add("Email", (CursorLeft, CursorTop));
        WriteLine(employee.Email.Trim().Any() ? employee.Email : "[UNDEFINED]");

        CursorLeft = Indent;
        Write("Phone Number:");
        CursorLeft = Indent + 18;
        Positions.Add("Phone", (CursorLeft, CursorTop));
        WriteLine(employee.PhoneNumber.Trim().Any() ? employee.PhoneNumber : "[UNDEFINED]");
